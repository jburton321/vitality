export const Hero = (): JSX.Element => {
  return (
    <section className="w-full bg-gradient-to-r from-blue-900 to-blue-600 px-4 sm:px-6 py-4 sm:py-6">
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center justify-start max-w-7xl mx-auto">
        <img
          ...
          className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 shrink-0 object-contain"
        />
