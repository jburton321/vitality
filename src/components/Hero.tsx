      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center justify-start max-w-7xl mx-auto">
        ...
        >
          <div className="rounded-full border-solid border-white border-2 flex flex-col gap-1 items-center justify-center w-24 h-24 sm:w-28 sm:h-28">
            <div
              className="flex flex-col gap-1 items-center justify-center -rotate-12"
            >
              <div className="text-white text-center font-semibold text-xs uppercase tracking-wide">
                Future of
              </div>
              <div className="text-yellow-400 text-left text-4xl sm:text-5xl font-normal" style={{ fontFamily: "FulltimeScript-Regular, sans-serif" }}>
                Travel
              </div>
              <div className="text-white text-center text-sm uppercase tracking-wide">
                FOCUS
                <br />
                GROUP
              </div>
        ...
        <div className="flex flex-col gap-2 items-start justify-start flex-1 text-center sm:text-left">
          <div className="text-2xl sm:text-3xl uppercase tracking-wide">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-center justify-start">
            <div className="text-white font-bold text-4xl sm:text-5xl uppercase">
              VACATION
            </div>
            <div className="text-white text-3xl sm:text-4xl" style={{ fontFamily: "Brinattan-Regular, sans-serif" }}>
              For Two!
            </div>
          </div>
        </div>
