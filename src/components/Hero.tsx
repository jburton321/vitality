export const Hero = (): JSX.Element => {
  return (
    <section className="w-full bg-gradient-to-r from-blue-900 to-blue-600 px-4 sm:px-6 pt-16 sm:pt-20 md:pt-24 pb-4 sm:pb-6 relative">
      <img
        src="/stamp.png"
        alt="Future of Travel Focus Group"
        className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 shrink-0 object-contain absolute left-1/2 sm:left-8 md:left-12 lg:left-[calc(50%-560px+24px)] -translate-x-1/2 sm:translate-x-0 -top-12 sm:-top-14 md:-top-16 z-10"
      />
